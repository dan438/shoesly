  ...
  return (
    <KeyboardAvoidingView
      ...
      <View style={{marginVertical: 30}}>
        <Text style={{fontSize: 24, fontWeight: '700'}}>Create an Account</Text>
      ...
      <View style={{marginBottom: 30}}>
        ...
        <Text style={{marginBottom: 30}}>Your password must 8 or more characters </Text>
        <View style={{marginBottom: 30}}>
          <Text style={{fontSize: 14, fontWeight: '700'}}>Confirm Password</Text>
          <View style={{position: 'relative'}}>
            <TextInput style={styles.input} placeholder="Enter your Password" />
            <Icon
              style={{
      ...
      <View style={{flex: 1, justifyContent: 'flex-end'}}>
        <View style={{paddingVertical: 30, flexDirection: "row", justifyContent: "space-between", alignItems: 'center'}}>
            <Icon
              style={{
